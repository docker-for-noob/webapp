...
const requiredError: Error<InfrastructureException> = error("This field is required");
const mustBeNumberError: Error<InfrastructureException> = error("Must be a number");
const mustBePositiveError: Error<InfrastructureException> = error(
    "Must be a positive number"
);
const mustBeStringError: Error<InfrastructureException> = error("Must be a string");
